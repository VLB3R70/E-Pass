...
class ModifyPassFrame(Toplevel):
    ...
    def __init__(self, root, master, password_id, user):
        ...
        self.modify_password = Button(self, text="Modify", bg='orange3', activebackground='orange1',
    ...
    def modify_password(self):
        ...
        if self.entry_site_name.get() != "":
            dao.update_site_name(id=self.password_id, new_site_name=self.entry_site_name.get())
            ...
            if self.entry_old_password.get() == dao.get_user_password(self.password_id):
                dao.update_user_password(self.password_id, self.entry_new_password.get())
                self.root.refresh_table(self.master, self.user)
            else:
