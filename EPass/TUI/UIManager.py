...
def mainMenu():
    ...
    while True:
        ...
        if selection == '0':
            ...
            dao.saveUserData(siteName=newSiteName, userName=newUserName, password=newPassword)
...
|_______|        |__|      \__,_| |____/ |____/"""
    ...
    while login:
        ...
        if election == '1':
            ...
            if securityChoice == 'y':
                dao.resetDataBase()
                newMasterPassword = Prompt.ask(prompt="[cyan]Enter the new master password", default="", password=True)
